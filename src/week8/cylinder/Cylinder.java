...
public class Cylinder extends Circle {
    ...
    // Constructor to initialize radius and height, calling the parent constructor
    public Cylinder(double radius, double height) {
        super(radius); // Call to the superclass (Circle) constructor
        if (height < 0) {
            this.height = 0;
        } else {
            this.height = height;
    ...
    public static void main(String[] args) {
        // Create a Circle instance and display its radius and area
        Circle circle = new Circle(3.75);
        System.out.println("circle.radius= " + circle.getRadius());
        System.out.println("circle.area= " + circle.getArea());

        // Create a Cylinder instance and display its radius, height, area, and volume
